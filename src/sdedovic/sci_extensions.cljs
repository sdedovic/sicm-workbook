(ns sdedovic.sci-extensions
    (:require [sdedovic.custom]
              [emmy.sci]
              [sci.ctx-store]
              [sci.core :as sci]))
...
(def custom-namespace
  (sci/copy-ns sdedovic.custom
               (sci/create-ns 'sdedovic.custom)))
...
(def custom-namespaces
  {'sdedovic.custom custom-namespace
...
;; `:as` form to a namespace: `(:require [sdedovic.custom :as custom])`
(def custom-aliases
  {'custom 'sdedovic.custom})
